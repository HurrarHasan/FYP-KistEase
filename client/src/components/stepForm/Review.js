...
export const Review = ({ formData, navigation }) => {
  ...
  const submitData = async () => {
    ...
    formData.append("customerEmail", CustomerEmailAddress);
    formData.append("customerPhoneNo", `+92${CustomerPhoneNumber}`);
    formData.append("customerAddress", CustomerAddress);
    formData.append("CNICNO", CustomerCnic);
    formData.append("guarantorName", GuarantorName);
    formData.append("guarantorEmail", GuarantorEmailAddress);
    formData.append("guarantorPhoneNo", `+92${GuarantorPhoneNumber}`);
    ...
    await api
      .post("registerCustomer", formData, config)
      .then((result) => {
        console.log({ result });
  ...
  return (
    <Container maxWidth="sm">
      ...
      <RenderAccordion
        ...
        details={[
          { Name: CustomerName },
          { "Phone Number": "+92" + CustomerPhoneNumber },
      ...
      <RenderAccordion
        ...
        details={[
          { Name: GuarantorName },
          { "Phone Number": "+92" + GuarantorPhoneNumber },
          { Email: GuarantorEmailAddress },
          { CNIC: GuarantorCnic },
        ]}
      />
