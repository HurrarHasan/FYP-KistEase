...
import { getGuarantorPicture, storeguarantorPicture } from "./StoreVariables"
...
export const GuarantorSignup = ({ formData, setForm, navigation }) => {
  ...
  useEffect(() => {
    ...
    let guarantorPicture = getGuarantorPicture();
    console.log({ guarantorPicture });
    setImage(guarantorPicture);
  }, []);
  useEffect(() => {
