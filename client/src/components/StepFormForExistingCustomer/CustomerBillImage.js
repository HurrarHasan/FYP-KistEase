...
import { getCustomerBill, storeCustomerBill } from "./StoreVariables";
...
export const CustomerBillImage = ({ formData, setForm, navigation }) => {
  const { CustomerBill } = formData;
  ...
  const onChangeFile1 = (e) => {
    if (e.target.files[0]) {
      ...
      console.log("Customer Bill Uploaded");
    }
  };
  ...
  useEffect(() => {
    console.table({ Image, ImagePreview });
  ...
  const nextPage = () => {
    storeCustomerBill(Image)
    navigation.next()
  }
  const isObject = (val) => {
    console.log("we in isObject")
  ...
  useEffect(() => {
    ...
    if (Image !== undefined && Image !== "") {
      if (isObject(Image)) {
        ...
        console.log("CustomerBill Image", { Image })
    ...
    <ThemeProvider theme={theme}>
      <Container component="main" maxWidth="xs">
        ...
        >
          ...
          {/* Customer Utility Bill Tittle */}
          <Typography component="h1" variant="h5">
            {" "}
            Upload Customer Utility Bill{" "}
          </Typography>
                ...
                >
                  <Input
                    ...
                    onChange={(e) => {
                      // onChangeFile1(e);
                      setImage(e.target.files[0]);
                      storeCustomerBill(e.target.files[0]);
                    }}
                  />
                  <Button
